...
Task("build")
    ...
    .Does(() => {
        ...
        DotNetCoreBuild("./src/Shorthand.ImageSharp.AVIF/Shorthand.ImageSharp.AVIF.csproj", buildSettings);
    });
...
Task("pack")
    ...
    .Does(() => {
        ...
        DotNetCorePack("./src/Shorthand.ImageSharp.AVIF/Shorthand.ImageSharp.AVIF.csproj", buildSettings);
    });
...
Task("test")
    ...
    .Does(() => {
        ...
        DotNetCoreTest("./test/Shorthand.ImageSharp.AVIF.Tests/Shorthand.ImageSharp.AVIF.Tests.csproj", settings, coverletSettings);
    });
